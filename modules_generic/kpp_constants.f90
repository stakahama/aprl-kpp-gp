! modified by ST 26 Feb to allow reading in of constant values
! define integer (0) original and (1) fixed in photolysis.txt
...
MODULE constants
  ...
  REAL(dp) kro2no, kro2ho2, kapho2, kapno, kro2no3, kno3al, kdec, &
    krosec, kalkoxy, kalkpxy, kroprim,KCH3O2,K298CH3O2,KMT18,NCD, &
